...
const Card = ({ key, type, date_started, header, title, description, organizer, image, numSupporters, targetNum, numLikes }) => { //Destructuring right here
    ...
    return (
        ...
        <article className="bt bb b--black-10">
            <div className="baskerville pv4 ph3 ph0-l black">
                <div className="container flex flex-column flex-row-ns">
                    <div className="h-auto db pr3-ns mb4 mb0-ns w-100 w-25-ns">
